/*
 * Added alias to click for debug with pointer devices
 * Source: https://github.com/zawaideh/toe.js/blob/c4a4d0fbf37ba7548e398b0d3b87357de97ba999/src/toe.js
 * Serra
 */
 ...
 */
    function touchstart(event) {
        $(event.target).trigger('toetouchstart');  // Added for styling controls while being touched  @by pedroserra/appsalad
 ...
 */
    function touchend(event) {
        $(event.target).trigger('toetouchend');  // Added for styling controls while being touched  @by pedroserra/appsalad
